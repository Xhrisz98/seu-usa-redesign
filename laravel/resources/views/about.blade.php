...
<section class="hero" style="padding: 4rem 0 2rem 0;">
  <div class="container">
    ...
    <h1 style="font-size: 3rem; margin-bottom: 1rem;">Building Futures, Connecting Talent</h1>
...
<section class="section-padding" style="background-color: var(--color-bg-secondary);">
  <div class="container">
    <div class="hero-grid" style="align-items: flex-start; gap: 3rem;">
      <div>
        <h2 style="font-size: 2rem; font-weight: 800; margin-bottom: 1.5rem;">Family Values. National Scale.</h2>
...
<section class="section-padding" id="team">
  <div class="container">
    ...
    <div class="team-grid">
      ...
      <div class="card-premium founder-card">
