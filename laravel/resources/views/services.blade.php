...
<section class="hero" style="padding: 4rem 0 2rem 0;">
  <div class="container reveal">
    ...
    <h1 style="margin-bottom: 1rem;">Mitigating Risk. Empowering Growth.</h1>
...
<section class="section-padding" style="background-color: var(--color-bg-secondary);">
  <div class="container">
    <div class="advantage-grid" style="grid-template-columns: repeat(3, 1fr);">
      ...
      <!-- Service Card 2 -->
      <div class="card-premium reveal reveal-delay-100">
        <div class="card-icon">
    ...
    <div class="card-premium reveal" style="margin-top: 3rem; display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
      <div>
...
<section class="section-padding">
  <div class="container">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 3rem; text-align: center;" class="reveal">
      <!-- Step 1 -->
      <div>
