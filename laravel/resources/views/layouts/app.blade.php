...
<html lang="en">
  <head>
    ...
    <title>@yield('title', 'Sunshine Enterprise USA | Premium Staffing & HR Solutions')</title>
    <meta name="description" content="@yield('meta_description', 'Connecting great companies with exceptional talent. Sunshine Enterprise USA provides compliant, efficient, and premium staffing solutions.')" />
    ...
    <div class="top-utility-bar">
      <div class="container">
        ...
        <div class="utility-badge">
          ...
          <span>E-Verify System Active</span>
        </div>
      </div>
    </div>
